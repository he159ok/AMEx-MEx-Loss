...
import shutil
import MyFunc
def findmykey(keyword2, head=os.path.abspath('.')):
    dirs=set()
    files=[]
    pattern='.*' + keyword2 + '.*'
    dirs.add(head)
...
DesName = "FID_global_TE_Real/"
# DesName = "FID_local_TR_Real/"


# keyword2 = "_SynMask_image_colormap" #For Whole Test
# keyword2 = "_SynLocal_colormap" # For Local Test
keyword2 = "_MaskP_Syn_imgGlo"  #For Local Train
# keyword1 = 'ColorSegProByJianfengHe_' #For NYU Training set
# keyword2 = "_leftImg8bit"   #For global Real
# keyword2 = "_gtFine_color"   #For global Seg
