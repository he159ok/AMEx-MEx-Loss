...
DesPath = '/home/jfhe/Documents/MyPix2pixHD2/datasets2/NYU/'
FileName = 'ShortShapeSet_NYU'+str(dataset_size) +'.json'
#在当前实验中,并未使用转换成固定规格之后的图片
DesFile = DesPath + FileName


ReadFile_MeanShape = open(DesFile, 'r', encoding='utf-8')
MeanShape_dict2 = json.load(ReadFile_MeanShape)
print("Test Read ShortShapeSet Successfully!")
...
if opt.gpu_ids[0] == 1:
    pretrain_classifier_path2 = 'TE_pretrained_classifier_gpu1_NYU.pkl'  # 'ED_pretrained_classifier_gpu1_NYU.pkl' For Train
elif opt.gpu_ids[0] == 0:
    pretrain_classifier_path2 = 'TE_pretrained_classifier_gpu0_NYU.pkl'  # 'ED_pretrained_classifier_gpu0_NYU.pkl' For Train
